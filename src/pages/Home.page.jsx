   ...
   console.log({popularMovies});
    ...
    <> 
     <div className="flex flex-col gap-10">
        ...
        <div className="bg-darkBackground-800 py-12 ">
          <div className="container mx-auto px-4 flex flex-col gap-3 lg:px-32">
     ...
     <div className="container mx-auto px-4 my-8 lg:px-32">
